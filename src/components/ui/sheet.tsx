...
type CustomSheetContentProps = {
  showX?: boolean;
};

type SheetContentProps = {} & React.ComponentPropsWithoutRef<typeof SheetPrimitive.Content> & CustomSheetContentProps & VariantProps<typeof sheetVariants>;
